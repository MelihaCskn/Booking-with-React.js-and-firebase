...
const ProfilDuzenleCorporate = ({ closeModal }) => { // closeModal prop'unu al
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      await updateDoc(doc(db, 'Corporate Users', currentUser.uid), {
        name: userData.name,
...
export default ProfilDuzenleCorporate;
